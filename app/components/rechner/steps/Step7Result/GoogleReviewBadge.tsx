  ...
  return (
    <div className="text-center mb-8">
      <a
        ...
        className="flex flex-col items-center gap-3 p-6 bg-background rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-border"
      >
        <GoogleLogo />
